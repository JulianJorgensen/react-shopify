...
class CartItem extends React.Component {
  render() {
    let {id, title, variantTitle, quantity, price, images} = this.props;
        ...
        <div className="cart-item__content">
          ...
          <div className="cart-item__content-row">
            <div className="cart-item__quantity-container">
              <button className="btn--seamless quantity-decrement" type="button"><span>-</span><span className="visuallyhidden">Decrement</span></button>
              <input defaultValue="1" className="cart-item__quantity" type="number" min="0" />
              <button className="btn--seamless quantity-increment" type="button"><span>+</span><span className="visuallyhidden">Increment</span></button>
            </div>
